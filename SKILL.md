---
name: bili-download
description: 把 B站创作者内容完整归档到本地(单视频或整合集,按合集分目录、序号命名、增量更新)。当用户要下载/备份/归档/保存/留存 B站视频时触发——尤其是某 UP 主的合集、系列、充电或付费课程,或给出 space.bilibili.com 链接 / 视频链接 / BV号。即使用户没明说"下载",只要提到把 B站内容存到本地、离线看、怕被删/下架想备份,也应触发。扫码登录后可归档已充电/已购的完整系列。
---
